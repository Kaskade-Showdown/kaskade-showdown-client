...
### PS!の背景や外観を変えるには?
背景を変更するには、右上の歯車ボタンをクリックして、"change background"をクリックしてください。好きな画像を選んだり、自分でアップロードすることができます。また、拡張機能「Stylish」をダウンロードすると、Kaskade Showdownの全体的な外観を変更することができます。

## ティアリング

### Smogonとは?

Smogonは、ポケモン構築、ガイド、フォーラム、そして独自のシミュレーターであるKaskade Showdownで構成される、ポケモン対戦に関する最も包括的で正確なリソースです。Kaskade Showdownでは、Smogonのティアリングがベースとなっています。
