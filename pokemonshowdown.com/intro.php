...
?>
		...
		<div class="main">
			...
			<p>
				Well, now you have a basic idea of how competitive battling works. If you'd like to dive straight in, play Kaskade Showdown! Our Random Battle format is great for learning the basics of competitive play.
			</p>
			<p class="mainbutton">
