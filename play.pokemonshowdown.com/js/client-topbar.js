(function ($) {
	...
	var CustomBackgroundPopup = this.CustomBackgroundPopup = Popup.extend({
		...
		updateSolidColorPreview: function (e) {
			...
			if (this.solidHue === undefined) this.solidHue = parsedHSV.h;
			if (this.solidSaturation === undefined) this.solidSaturation = parsedHSV.s;
			if (this.solidValue === undefined) this.solidValue = parsedHSV.v;
			if (e && e.currentTarget && e.currentTarget.name === 'solidcolor' && parsedHSV.s > 0) {
