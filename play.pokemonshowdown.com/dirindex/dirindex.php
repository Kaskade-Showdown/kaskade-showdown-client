...
<html lang="en"><head>
	...
	<title><?= htmlentities(function_exists('dirindex_title') ? dirindex_title() : $rel_dir) ?> - Kaskade Showdown!</title>
...
<?php } ?>
	...
	<header>
		<div class="nav-wrapper"><ul class="nav">
			<li><a class="button nav-first" href="//kaskadeshowdown.com/"><img src="//kaskadeshowdown.com/pokemonshowdownbeta.png" srcset="//kaskadeshowdown.com/pokemonshowdownbeta.png 1x, //kaskadeshowdown.com/pokemonshowdownbeta@2x.png 2x" alt="Kaskade Showdown" width="146" height="44" /> Home</a></li>
			<li><a class="button" href="//kaskadeshowdown.com/dex/">Pok&eacute;dex</a></li>
			<li><a class="button" href="//replay.kaskadeshowdown.com/">Replay</a></li>
			<li><a class="button purplebutton" href="//kaskadeshowdown.com/dex/" target="_blank">Strategy</a></li>
			<li><a class="button nav-last purplebutton" href="//kaskadeshowdown.com/forums/" target="_blank">Forum</a></li>
			<li><a class="button greenbutton nav-first nav-last" href="//kaskadeshowdown.com/">Play</a></li>
		</ul></div>
	</header>
